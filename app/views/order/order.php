...
<div style="background-image:url(<?= SROOT ?>assets/img/profile_background.jpg); background-size:cover; background-attachment:fixed; font-family:Aclonica; min-width:1395px;">
    ...
    <div class="card-header py-2 mx-4 mb-3 mt-0 d-flex justify-content-between align-items-center"
        style="background:#9d2525; color:white; font-family:Aclonica;margin-top:2rem;">
        <div></div>
        <h3>My Current Order</h3>
        <div></div>
    </div>
    <div class="container pb-5">
        <div class="card card-cascade narrower mt-0 mx-3 p-5" style="background:rgb(255,255,255,.7);">

            <?php if (isset($this->items) && !empty($this->items)) : ?>
            <h2> Resataurant : <a href="<?= SROOT . 'restaurant/details/' . $this->restaurant->id ?>">
                    <?= $this->restaurant->restaurant_name ?> </a> </h2>
            <div>
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-th="Quantity">
                                <input type="number" class="form-control text-center" id=<?= $item->id ?> min=1 max=20
                                    name="quantity" value=<?= $item->quantity ?>>
                            </td>
                            <td data-th="Subtotal" class="text-center"><?= ($item->price * $item->quantity) . " LKR" ?>
                            </td>
                            <?php $this->total += $item->price * $item->quantity ?>
                            <td class="actions" data-th="">
                                <!-- <button class="btn btn-info btn-sm"><i class="fa fa-refresh"></i></button> -->
                                <a href="<?= SROOT . 'order/remove_from_order/' . $item->id ?>"><button
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td><a href="javascript:history.go(-1)" class="btn btn-warning"><i
                                        class="fa fa-angle-left"></i> Continue Shopping</a></td>
                            <td colspan="2" class="hidden-xs"></td>
                            <td class="hidden-xs text-center" id="total"><strong>Total
                                    <?= ($this->total) . " LKR" ?></strong></td>
                            <td><a data-toggle="modal" data-target="#order_submit_form"
                                    class="btn btn-success btn-block">Submit Order <i class="fa fa-angle-right"></i></a>
                            </td>
                        </tr>
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class=" text-center"><?= $item->price . " LKR" ?>
                                                                </td>
                                                                <td class=" text-center"
                                                                    id="receipt-subtotal-<?= $item->id ?>">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>   </td>
                                                                <td class="text-right">
                                                                    <h5 style="color:black"><strong>Total: </strong>
                                                                        </h4>
                                                                </td>
                                                                <td class="text-center text-danger">
                                                                    <h5 style="color:red"><strong
                                                                            id="receipt-total"><?= $this->total . ' LKR' ?></strong>
                                                                        </h4>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <div class="text-center font-weight-bold">
                                                        <h3>Your Order Code is : <b><?= $this->new_order_code ?></b>
                                                        </h3>
                                                    </div>
                ...
                <?php else : ?>
                <h2 style="font-family:Aclonica; margin-bottom:2rem;">No items selected for current order
                </h2>
                <a href="<?= SROOT ?>search/restaurant"><button
                        style="margin:10px; margin-bottom:2rem; padding:10px; background-color:#ea0; font-family:Aclonica; border:0px; color:white; border-bottom-right-radius:10px;">
                        Choose New Restaurant </button></a>
                <a href="<?= SROOT ?>search/food"><button
                        style="margin:10px; margin-bottom:2rem; padding:10px; background-color:#d95d36; font-family:Aclonica; border:0px; color:white; border-bottom-right-radius:10px;">
                        Discover New Tastes </button></a>
                <?php endif ?>

                <div class="row mt-5" style="font-family:Aclonica">
                    <div class="col"
                        style="border-width:2px 5px 5px 2px; border-color:#9d2525; border-style:solid; border-bottom-right-radius:20px;margin-right:2rem;">
                        <h3 class="mt-4">Saved Orders</h3>
                        ...
                        <div style="height:20rem; overflow-y:auto; overflow-x:hidden; ">
                            ...
                            <div class="row">
                                <div class="dropdown" style="width:80%; margin:2%;">
                                    <button class="btn btn-secondary dropdown-toggle order" type="button"
                                        id="<?= $order->id ?>" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false" style="width: 100%;"> <?= $order->order_name ?> </button>
                    ...
                    <div class="col"
                        style="border-width:2px 5px 5px 2px; border-color:#9d2525; border-style:solid; border-bottom-right-radius:20px;margin-left:2rem;">
                        <h3 class="mt-4">Submitted Orders</h3>
                        ...
                        <div style="height:20rem; overflow-y:auto;overflow-x:hidden;">
                            ...
                            <div class="row">
                                <div class="dropdown" style="width:80%; margin:2%;">
                                    <button class="btn btn-secondary dropdown-toggle order" type="button"
                                        id="<?= $order->id ?>" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false" style="width: 100%;"> <?= $order->time_stamp ?> </button>
                                    <div class="dropdown-menu" aria-labelledby="<?= $order->id ?>" role="menu">
                                        <img src="" alt="loading...">
                                    </div>
                                </div>
