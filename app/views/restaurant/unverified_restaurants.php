...
<?php $this->set_title('Unverified Restaurants'); ?>

<?php $this->start('head'); ?>
<?php $this->end(); ?>

<?php $this->start('body'); ?>
<h3 class="text-center">Unverified Restaurants</h3>
    ...
    <tbody>
        <?php foreach($this->restaurants as $restaurant): ?>
            <tr>
                ...
                <td class="text-right">
                    <a href="<?=SROOT?>restaurant/verify/<?=$restaurant->id?>" class="btn btn-primary" onclick= "if(!confirm('Are you sure?')){return false;}">Verify</a>
